...
def load_fgs(filename):
    with open(f"{data_dir}/{filename}") as f:
        return json.load(f)["fgs"]
...
fp16_csr = load_fgs("with_fp16_fgs_csr_cuda_results.json")
bf16_csr = load_fgs("with_bf16_fgs_csr_cuda_results.json")
fp16_ell = load_fgs("with_fp16_fgs_ell_cuda_results.json")
bf16_ell = load_fgs("with_bf16_fgs_ell_cuda_results.json")
...
fig.tight_layout()
fig.savefig("fgs_time.pdf", bbox_inches="tight")
print("Saved fgs_time.pdf")
...
fig2.tight_layout()
fig2.savefig("fgs_speedup.pdf", bbox_inches="tight")
print("Saved fgs_speedup.pdf")
